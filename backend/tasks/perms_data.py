...
perms = {
    ...
    "di:transform": (
        "Transformer une demande d'intervention en bon de travail",
        "action",
        "di:viewDetail",
    ),
    ...
    "eq:view.calendar": (
        "Voir le calendrier des maintenances d'un équipement",
        "affichage",
        "eq:viewDetail",
    ),
    ...
    "eq:kpi.view": (
        "Voir les indicateurs KPI de maintenance d'un équipement",
        "affichage",
        "eq:viewDetail",
    ),
    "eq:historique.view": (
        "Voir l'historique des états d'un équipement",
        "affichage",
        "eq:viewDetail",
    ),
    # ── Compteurs ────────────────────────────────────────────────────────────
    ...
    # ── Avaries & diagnostic véhicule ────────────────────────────────────────
    "incident:viewList": ("Voir la liste des incidents véhicule", "affichage", None),
    "incident:viewDetail": (
        "Voir le détail d'un incident véhicule",
        "affichage",
        "incident:viewList",
    ),
    "incident:create": ("Signaler un incident véhicule", "action", "incident:viewList"),
    "incident:edit": ("Modifier un incident véhicule", "action", "incident:viewDetail"),
    "incident:delete": ("Supprimer un incident véhicule", "action", "incident:viewDetail"),
    "sinistre:viewList": ("Voir la liste des sinistres", "affichage", None),
    "sinistre:viewDetail": ("Voir le détail d'un sinistre", "affichage", "sinistre:viewList"),
    "sinistre:create": ("Déclarer un sinistre", "action", "sinistre:viewList"),
    "sinistre:edit": ("Modifier un sinistre", "action", "sinistre:viewDetail"),
    "obd:viewList": ("Voir la liste des codes défaut OBD", "affichage", None),
    "obd:viewDetail": ("Voir le détail d'un code défaut OBD", "affichage", "obd:viewList"),
    "obd:create": ("Saisir un code défaut OBD", "action", "obd:viewList"),
    "obd:edit": ("Modifier un code défaut OBD", "action", "obd:viewDetail"),
    "obd:delete": ("Supprimer un code défaut OBD", "action", "obd:viewDetail"),
    # ── Export global ────────────────────────────────────────────────────────
    ...
    "export:histcons": (
        "Exporter l'historique des achats de consommables",
        "action",
        "export:view",
    ),
    ...
    # ── Dashboard ────────────────────────────────────────────────────────────
    "dash:display.di": (
        "Afficher les demandes d'intervention sur le tableau de bord",
        "affichage",
        None,
    ),
    "dash:display.diCreated": (
        "Afficher ses demandes d'intervention sur le tableau de bord",
        "affichage",
        None,
    ),
    "dash:display.bt": ("Afficher les bons de travail sur le tableau de bord", "affichage", None),
    "dash:display.btAssigned": (
        "Afficher ses bons de travail assignés sur le tableau de bord",
        "affichage",
        None,
    ),
...
perms_map = {
    ...
    "Magasinier": [
        "bt:viewList",
        "bt:viewDetail",
        "bt:acceptConsumableRequest",
        "stock:view",
        "stock:export",
        "stock:viewReservations",
        "stock:addPurchase",
        "stock:transfer",
        "cons:viewDetail",
        "cons:create",
